...
//  public Ninja Morse, Giavanna, Webber;
//  public ArrayList<Ninja> ninjaz = new ArrayList();
    public Enemy Aldo, Eli, Colby;
    ...
    public void init(GameContainer gc, StateBasedGame sbg)
		...
		// Scenerey Stuff
		// ****************
        grassMap = new TiledMap("res/SlickGame_Segovia.tmx");
...
//      Giavanna = new Ninja(0, 0);
//      Webber = new Ninja(10, 10);
        Aldo = new Enemy(50,50);
        Eli = new Enemy(30,30);
        Colby = new Enemy(10,10);
        enemiez.add(Aldo);
        enemiez.add(Eli);
        enemiez.add(Colby);
...
//		 System.out.println("Current X: " +Player.x + " \n Current Y: " + Player.y);
        ...
        g.drawString("Current Cash: " + Player.health / 1000, camera.cameraX + 10,
                camera.cameraY + 10);
...
//      Giavanna.currentImage.draw(Giavanna.x, Giavanna.y);
//      Webber.currentImage.draw(Webber.x, Webber.y);
